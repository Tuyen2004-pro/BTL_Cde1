...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px">
    <div></div>
    <a href="{{ route('tables.create') }}" class="btn-espresso">
...
<div class="card-cafe">
    <div class="empty-state">
        ...
        <p>Chưa có bàn nào. <a href="{{ route('tables.create') }}" style="color:var(--caramel)">Thêm ngay</a></p>
    </div>
</div>
@else
<div class="row g-3">
    ...
    <div class="col-md-4 col-lg-3">
        ...
        <div style="display:flex;gap:8px">
            <a href="{{ route('tables.edit', $table->id) }}" class="btn-outline-cafe"
                style="flex:1;justify-content:center;padding:7px 10px;font-size:.8rem">
                <i class="bi bi-pencil"></i> Sửa
            </a>
            <form id="del-tbl-{{ $table->id }}" action="{{ route('tables.destroy', $table->id) }}" method="POST">
                @csrf @method('DELETE')
            </form>
