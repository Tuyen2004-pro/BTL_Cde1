    ...
    <div class="col-lg-6">
        <div class="card-cafe">
            <div class="card-header-cafe">
                <h5><i class="bi bi-pencil-square me-2" style="color:var(--caramel)"></i>Sửa danh mục</h5>
            </div>
            <div class="card-body-cafe">
                <form action="{{ route('categories.update', $category->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="form-control-cafe" rows="4">{{ old('description', $category->description) }}</textarea>
                    </div>
